...
public class StubInput implements Input {
     ...
     * Например, если пользователь хочет выбрать добавление новой заявки,
     * ему в консоли нужно ввести:
     ...
     *
     * @param question - вопрос от пользователя (выбор пункта меню).
     *                 Но в версии StubInput он не используется
     *                 т.к. массив ответов заранее определен при инициализации
     *                 класса и сохранен в value
     * @return - один из заранее определенных ответов пользователей, хранящихся
     * в value[position++].
     */
    @Override
    ...
    /**
     * В текущем релизе данный метод является заглушкой для реализации наследования
     * RuntimeExchange()
     * @param question - ...
     * @param range - ...
     * @return - ...
